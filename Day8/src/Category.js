...
const Category = () => {
  ...
  return (
    ...
    <nav className='catNavbarItems'>
      <h1 className='catnavbar-logo'>Trippy</h1>

      <div className='catmenu-icons' onClick={handleClick}>
      ...
      <ul className='catnav-menu'>
        ...
        <li>
          <a href='/' className='catCart'>
            <ShoppingCartIcon></ShoppingCartIcon>Cart
          </a>
        </li>
        <li>
          <a href='/' className='catFeedback'>
