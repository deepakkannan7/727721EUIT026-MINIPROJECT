...
import HrManagementSystem.Model.Department;
import HrManagementSystem.Model.Dependents;
import HrManagementSystem.Model.EmpAddress;
import HrManagementSystem.Model.EmpContact;
import HrManagementSystem.Model.EmpDept;
import HrManagementSystem.Model.Employee;
import HrManagementSystem.Service.DepartmentDAO;
import HrManagementSystem.Service.DependentsDAO;
import HrManagementSystem.Service.EmpAddressDAO;
import HrManagementSystem.Service.EmpContactDAO;
import HrManagementSystem.Service.EmpDeptDAO;
import HrManagementSystem.Service.EmployeeDAO;
...
public class HRManagementSystem {
	...
	private static void displayMenu() {
		 System.out.println(   "╭──────────────────────────────────────────────────────────────────────────────────────────╮");
	        ...
	        System.out.println("│ 16. Add Dependent for Employee   │");
