...
const Homepage1 = () => {
  ...
  return (
    ...
    <nav className='hNavbarItems'>
      <h1 className='hnavbar-logo' onClick={handleClick}>KK
      {dropdownVisible && (
...
<div className='hmenu-icons' onClick={handle1Click}>
        <i className={clicked ? 'fas fa-times' : 'fas fa-bars'}></i>
      </div>

      <ul className={`hnav-menu ${clicked ? 'active' : ''}`}>
     <Link to='./Homepage1'>
        <li className='#'>
