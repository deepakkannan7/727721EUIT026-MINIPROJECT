...
//             KK
//             {dropdownVisible && (
//               <div className='bakdropdown-menu'>
...
//       <div className='bakmenu-icons' onClick={handle1Click}>
//         <i className={clicked ? 'fas fa-times' : 'fas fa-bars'}></i>
//       </div>

//       <ul className={`baknav-menu ${clicked ? 'active' : ''}`}>
//             <Link to='./Homepage1'>
//               <li className='#'>
//                 <a href='/' className='bakHome'>
//                   <HomeIcon></HomeIcon>Home
...
//       <div className='baksearch-container'>
//           <input
//             type='text'
//             className='search-input'
