...
product.name.toLowerCase().includes(searchTerm.toLowerCase())
  ...
  return (
    ...
    <nav className='fNavbarItems'>
      <h1 className='fnavbar-logo' onClick={handleClick}>KK
      {dropdownVisible && (
              <div className='fdropdown-menu'>
...
<div className='fmenu-icons' onClick={handle1Click}>
        <i className={clicked ? 'fas fa-times' : 'fas fa-bars'}></i>
      </div>

      <ul className={`fnav-menu ${clicked ? 'active' : ''}`}>
     <Link to='./Homepage1'>
        <li className='#'>
    ...
    <div className='frsearch-container'>
          <input
            type='text'
            className='search-input'
