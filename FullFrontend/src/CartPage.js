...
<div>
    ...
    <nav className='carNavbarItems'>
      <h1 className='carnavbar-logo' onClick={handleClick}>KK
      {dropdownVisible && (
...
<div className='carmenu-icons' onClick={handle1Click}>
        <i className={clicked ? 'fas fa-times' : 'fas fa-bars'}></i>
      </div>

      <ul className={`carnav-menu ${clicked ? 'active' : ''}`}>
      ...
      {cartItems.length === 0 ? (
        ...
        <div><center>
          {cartItems.map((item) => (
            ...
            <div key={item.id}>
              <div id="nameblock">
              <h3 className='name'>{item.pname}</h3></div>
              <div id="imgblock">
                <img
                  src={item.pimagesUrl}
                  alt={item.pname}
              ...
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              <div id="priceblock">
              <p className='tt'>Price:₹ {item.pprice}</p></div>
